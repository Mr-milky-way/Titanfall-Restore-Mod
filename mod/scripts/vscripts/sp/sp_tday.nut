...
void function CodeCallback_MapInit()
{
    ...
    FlagInit( "StartPoint_TrailerDropFlag" )
    ...
    AddStartPoint( "Trailer - Drop", 			StartPoint_TrailerDrop, StartPoint_Setup_TrailerDrop)
...
void function StartPoint_TrailerDrop( entity player ) {
    ...
    if (Flag("StartPoint_TrailerDropFlag")){
        ...
        entity trailerSpawner3 = file.trailerSpawner3.SpawnEntity()
        entity trailerSpawner4 = file.trailerSpawner4.SpawnEntity()
        entity trailerSpawner5 = file.trailerSpawner5.SpawnEntity()

        DispatchSpawn(trailerSpawner1)
        DispatchSpawn(trailerSpawner2)
        DispatchSpawn(trailerSpawner3)
        DispatchSpawn(trailerSpawner4)
        DispatchSpawn(trailerSpawner5)
    }
}

void function StartPoint_Setup_TrailerDrop ( entity player ) {
	TeleportPlayerAndBT( "start_player_WallBombardment", "start_bt_WallBombardment" )
    FlagSet("StartPoint_TrailerDropFlag")
}
...
void function PlayerBlastedBack( entity player )
{
	...
	entity node = GetClosest( nodes, player.GetOrigin(), 500 )
