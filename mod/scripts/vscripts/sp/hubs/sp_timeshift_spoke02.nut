...
const LABRAT_MODEL = $"models/humans/heroes/mlt_hero_anderson.mdl"
...
void function CodeCallback_MapInit()
{
    ...
    FlagInit( "security_concourse_01_hacked" )
    FlagInit( "security_concourse_02_hacked" )
...
*/
	...
	//He's here!
	thread PlayTimeShiftDialogue( player, loudspeakerEnt3, "diag_sp_humanStudy_TS202_01_01_imc_scientist1" )
...
void function HumanPodsThink( string instanceNamePristine, string instanceNameOvergrown, entity player )
{
    ...
    FlagSet("security_concourse_01_hacked")
    FlagSet("security_concourse_02_hacked")
	entity dialogueEnt = CreateLoudspeakerEnt( player.GetOrigin() )
	...
	wait 5
	thread PlayTimeShiftDialogue( player, dialogueEnt, prisonerDialogue, 1 )
}
